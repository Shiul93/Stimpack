    ...
    methods
        ...
        function runTrials(obj)
            ...
            while trial <= numTrials
               ...
               fixationOK = [-dotSize+2 -dotSize+2 dotSize+2 dotSize+2];
               ...
               obj.fixationWindow = CenterRect(obj.fixationWindow, obj.wRect);
                ...
                WaitSecs(0.001);
                Eyelink('Message', '!V IAREA ELLIPSE %d %d %d %d %d %s', 1, floor(obj.winWidth/2-dotSize), floor(obj.winHeight/2-dotSize), floor(obj.winWidth/2+dotSize), floor(obj.winHeight/2+dotSize),'center');
